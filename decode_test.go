...
func TestUnmarshalEmbeddedUnexported(t *testing.T) {
	...
	tests := []struct {
		...
		ptr: new(S1),
		out: &S1{R: 2},
		err: fmt.Errorf("json: cannot set embedded pointer to unexported struct: expjson.embed1"),
	}, {
		...
		ptr: new(S5),
		out: &S5{R: 2},
		err: fmt.Errorf("json: cannot set embedded pointer to unexported struct: expjson.embed3"),
	}, {
